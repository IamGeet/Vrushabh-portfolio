            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className={`relative flex justify-center items-center ${getContainerHeight()} order-1 lg:order-2`}>
                ...
                >
                  ...
                  >
                    <img
                      src="/images/vrushabh-professional.jpg"
                      alt="Vrushabh Vakhare - ASIC Physical Design Engineer"
                ...
                {/* AI Engineer - Top */}
                <motion.div
                  className={`absolute ${badgePositions.aiEngineer} z-30`}
                  animate={{
                    y: [0, isMobile ? -5 : -10, 0],
                    opacity: [0.8, 1, 0.8],
                  }}
                ...
                >
                  <div
                    className={`bg-blue-500/30 backdrop-blur-md border border-blue-400/50 ${badgeSize} rounded-full text-blue-200 font-medium shadow-xl whitespace-nowrap`}
                  >
                    ASIC Engineer
                  </div>
                </motion.div>
                ...
                <motion.div
                  className={`absolute ${badgePositions.pythonDev} z-30`}
                  animate={{
                    x: [0, isMobile ? 5 : 10, 0],
                    opacity: [0.8, 1, 0.8],
                  }}
                ...
                >
                  <div
                    className={`bg-green-500/30 backdrop-blur-md border border-green-400/50 ${badgeSize} rounded-full text-green-200 font-medium shadow-xl whitespace-nowrap`}
                  >
                    Physical Design
                  </div>
                </motion.div>

                {/* Timing Closure - Bottom */}
                <motion.div
                  className={`absolute ${badgePositions.llmDev} z-30`}
                  animate={{
                    y: [0, isMobile ? 5 : 10, 0],
                    opacity: [0.8, 1, 0.8],
                  }}
                ...
                >
                  <div
                    className={`bg-purple-500/30 backdrop-blur-md border border-purple-400/50 ${badgeSize} rounded-full text-purple-200 font-medium shadow-xl whitespace-nowrap`}
                  >
                    Timing Closure
                  </div>
                </motion.div>

                {/* Power Optimization - Left */}
                <motion.div
                  className={`absolute ${badgePositions.promptEngineer} z-30`}
                  animate={{
                    x: [0, isMobile ? -5 : -10, 0],
                    opacity: [0.8, 1, 0.8],
                  }}
                ...
                >
                  <div
                    className={`bg-cyan-500/30 backdrop-blur-md border border-cyan-400/50 ${badgeSize} rounded-full text-cyan-200 font-medium shadow-xl whitespace-nowrap`}
                  >
                    Power Optimization
                  </div>
                </motion.div>
